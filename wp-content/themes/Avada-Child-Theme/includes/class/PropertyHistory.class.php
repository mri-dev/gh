...
class PropertyHistory extends PropertyFactory
{
  ...
  public function modText( $key = '' )
  {
    ...
    $texts = array(
        ...
        __( 'Rejtés a magyar nyelvű oldalon', 'gh' )  => '_listing_flag_hu_off',
        ...
        __( 'Csak Premium hirdetés', 'gh' )  => '_listing_premium_only',
