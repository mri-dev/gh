...
<div class="searcher-header">
 ...
 --><? foreach( $regions as $r ): if($r->parent != 0) continue; ?><!--
  --><li>
      <input type="radio" id="region_<?=$r->term_id?>" name="region" value="<?=$r->term_id?>"> <label for="region_<?=$r->term_id?>"><?=$r->name?></label>
    </li><!--
 --><? endforeach; ?>
  </ul>
</div>
<div class="searcher-wrapper">
    <div class="form-items">
      <div class="inp inp-city">
        ...
        <input type="text" id="searcher_city" class="form-control" value="" placeholder="<?=__('Összes', 'gh')?>">
      ...
      <div class="inp inp-kategoria">
        ...
        <input type="hidden" id="kategoria_multiselect_ids" name="cat" value="">
      ...
      <div class="inp inp-status">
        ...
        <input type="hidden" id="status_multiselect_ids" name="status" value="">
      ...
      <div class="inp inp-price-min">
        ...
        <input type="text" class="form-control pricebind" id="searcher_price_min" name="price_min" placeholder="<?=__('MFt', 'gh')?>" value="">
      </div>
      <div class="inp inp-price-max">
        <label for="searcher_price_max"><?=__('Maximum ár (Ft)', 'gh')?></label>
        <input type="text" class="form-control pricebind" id="searcher_price_max" name="price_max" placeholder="<?=__('MFt', 'gh')?>" value="">
      </div>
