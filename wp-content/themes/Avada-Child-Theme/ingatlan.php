        ...
        <div class="data-top-left">
          <div class="cwrapper">
            <div class="title">
              ...
              <div class="icons">
                <div class="facebook">
                  <a href="javascript:void(0);" onclick="window.open('https://www.facebook.com/dialog/share?app_id=<?=FB_APP_ID?>&amp;display=popup&amp;href=<?=get_option('siteurl', '').$_SERVER['REQUEST_URI']?><?=($_GET['share']=='')?'?share=fb'.((is_user_logged_in())?'.u-'.get_current_user_id():''):''?>&amp;redirect_uri=<?=get_option('siteurl', '')?>','','width=800, height=240')"><i class="fa fa-facebook"></i></a>
                </div>
                <div class="gplus">
